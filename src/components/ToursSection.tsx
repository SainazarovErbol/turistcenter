...
import { Star, Clock, ArrowRight, BadgeCheck, Eye } from "lucide-react";
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="flex items-center gap-1 text-xs text-muted-foreground">
                      ...
                      {(tour.viewCount ?? 0).toLocaleString(locale)} {t("views")}
                    </span>
                    <Button size="sm" variant="outline" nativeButton={false} render={<Link href="/tours" />}>
                      {t("details")}
                    </Button>
                  </div>
                </div>
